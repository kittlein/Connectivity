...
- Neutral-locus filtering and directional connectivity estimation: `code_annex/filter_neutral_loci_and_estimate_connectivity.R`
- Iterative connectivity-surface modelling: `code_annex/model_connectivity_surface.R`
- Seasonal extraction of polygon-based environmental covariates: `code_annex/extract_seasonal_polygon_covariates.R`
- Recruitment time-series modelling: `code_annex/fit_recruitment_time_series.R`

## Reference note

For the citable bibliography and manuscript-formatted version of this supplement, see `supplementary_material.tex` and `biblio.bib`.
