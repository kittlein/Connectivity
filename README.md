...
Associated script: [`code_annex/filter_neutral_loci_and_estimate_connectivity.R`](code_annex/filter_neutral_loci_and_estimate_connectivity.R).
...
Associated script: [`code_annex/model_connectivity_surface.R`](code_annex/model_connectivity_surface.R).
...
Associated script: [`code_annex/extract_seasonal_polygon_covariates.R`](code_annex/extract_seasonal_polygon_covariates.R).
...
Associated script: [`code_annex/fit_recruitment_time_series.R`](code_annex/fit_recruitment_time_series.R).

## Code annex

Curated versions of the core analysis scripts are distributed as separate files in the `code_annex/` directory. The scripts were simplified to retain only the steps required for the main analyses and to remove auxiliary plotting and post-processing routines on which the tables and figures presented in the main manuscript are derived.

- Neutral-locus filtering and directional connectivity estimation: [`code_annex/filter_neutral_loci_and_estimate_connectivity.R`](code_annex/filter_neutral_loci_and_estimate_connectivity.R)
- Iterative connectivity-surface modelling: [`code_annex/model_connectivity_surface.R`](code_annex/model_connectivity_surface.R)
- Seasonal extraction of polygon-based environmental covariates: [`code_annex/extract_seasonal_polygon_covariates.R`](code_annex/extract_seasonal_polygon_covariates.R)
- Recruitment time-series modelling: [`code_annex/fit_recruitment_time_series.R`](code_annex/fit_recruitment_time_series.R)
