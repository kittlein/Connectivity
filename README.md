...
Associated script: [`/filter_neutral_loci_and_estimate_connectivity.R`](https://github.com/kittlein/Connectivity//filter_neutral_loci_and_estimate_connectivity.R).
...
Associated script: [`/model_connectivity_surface.R`](https://github.com/kittlein/Connectivity//model_connectivity_surface.R).
...
Associated script: [`/extract_seasonal_polygon_covariates.R`](https://github.com/kittlein/Connectivity//extract_seasonal_polygon_covariates.R).
...
Associated script: [`/fit_recruitment_time_series.R`](https://github.com/kittlein/Connectivity//fit_recruitment_time_series.R).
...
- Neutral-locus filtering and directional connectivity estimation: [`/filter_neutral_loci_and_estimate_connectivity.R`](https://github.com/kittlein/Connectivity//filter_neutral_loci_and_estimate_connectivity.R)
- Iterative connectivity-surface modelling: [`/model_connectivity_surface.R`](https://github.com/kittlein/Connectivity//model_connectivity_surface.R)
- Seasonal extraction of polygon-based environmental covariates: [`/extract_seasonal_polygon_covariates.R`](https://github.com/kittlein/Connectivity//extract_seasonal_polygon_covariates.R)
- Recruitment time-series modelling: [`/fit_recruitment_time_series.R`](https://github.com/kittlein/Connectivity//fit_recruitment_time_series.R)
