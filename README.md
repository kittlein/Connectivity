...
Monthly environmental values were extracted for each focal polygon from NetCDF (`.nc`) files spanning 1993-2023. These files contain the environmental-variable time series derived from Copernicus Marine products: `chla_monthly_1993-2023-herring.nc` for chlorophyll-*a* : [download](https://drive.google.com/file/d/1PdxVjSILWYQwBZ6LHRFqoPs-7iP4T78d/view?usp=sharing), `sst_sss_monthly_1993-2023-herring.nc` for sea surface temperature and sea surface salinity : [download](https://drive.google.com/file/d/1x7urjw_ZNzYyQVEfxQkgQFV_DJpkyTLv/view?usp=sharing), and `vo_uo_monthly_1993-2023-herring.nc` for the zonal and meridional surface-current components : [download](https://drive.google.com/file/d/1rT-Y2sA05uYGn_tQkkVdJP2zoKwXetVb/view?usp=sharing). The NetCDF files were downloaded from Copernicus Marine for the spatial extent of the study region and contain monthly environmental time series covering 1993–2023. The NetCDF files containing the monthly environmental time series derived from Copernicus Marine are not included directly in this repository because of GitHub file-size limitations. However, they are available for download from Google Drive from the links above.
